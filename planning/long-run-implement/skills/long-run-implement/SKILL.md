...
3. **完了したら即チェック**: todo.md の該当 TODO を `[x]` に更新
4. **発見した追加作業**: 実装中に「これもやらないと」と気づいたら、即座に todo.md に追加 TODO として書く。`[+]` マーカーで「後から追加された」ことを示す
5. **困ったらメモ**: 懸念や判断に迷った点は todo.md にインラインコメントとして残す
...
- 全ての作業状態は todo.md に記録される
- 「何をやったか」「何が残っているか」は常に todo.md を見れば分かる状態を維持する
- todo.md を更新し忘れない。実装の前後で必ず更新する
